...
export default function AlumniDashboard() {
  ...
  useEffect(() => {
    ...
    if (u.role !== "alumni" && u.role !== "batch_admin") {
      router.push("/auth/login");
      return;
    }
    setUser(u);
  ...
  const recentActivity = [
    {
      user: "Dr. Sarah Chen",
      action: "posted a new research update in",
      target: "Faculty News",
      time: "3H AGO",
      avatar: mockAlumni[2].profilePicture,
    },
    {
      user: "Mark Davis",
      action: "started a new position as Director of Product at",
      target: "Google",
      time: "5H AGO",
      avatar: mockAlumni[1].profilePicture,
    },
    {
      user: "Alumni Relations",
      action: "announced the start of the",
      target: "Annual Giving Campaign",
      time: "YESTERDAY",
      avatar: null,
    },
  ];
            ...
            <div className="card p-5">
              ...
              <div className="flex items-center gap-4 text-sm text-gray-500 mb-4">
                <span className="flex items-center gap-1">
                  <TrendingUp className="h-3.5 w-3.5" /> $140k - $180k
                </span>
                <span className="flex items-center gap-1">
                  <Star className="h-3.5 w-3.5" /> Full-time
                </span>
              </div>
