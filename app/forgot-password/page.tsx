      ...
      <div className="hidden lg:flex lg:w-1/2 bg-navy-950 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            Enter your email and, if it exists in the system, we&apos;ll send a secure reset link.
          </p>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          {success ? (
            <div className="card p-6 text-center">
              ...
              <h3 className="font-semibold text-navy-900 text-lg mb-2">Check your inbox</h3>
              <p className="text-sm text-gray-600 leading-relaxed">{SUCCESS_MESSAGE}</p>
              <Link
                href="/auth/login"
