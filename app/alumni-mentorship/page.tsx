...
import { getAllMentorships } from "@/lib/api/mentorship";
                ...
                {filtered.map(m=>(
                    ...
                    className="border rounded-xl p-6 shadow-sm">
                        ...
                        {!m.applicationOpen &&(
                            ...
                            <div
                            className="bg-red-100 text-red-700 mt-4 p-2 rounded">
