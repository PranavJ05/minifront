      ...
      <div className="bg-navy-950 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-400">
            Stay updated with our alumni community
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {featured && (
          <div className="card overflow-hidden mb-8 grid lg:grid-cols-5">
            ...
            <div className="lg:col-span-3 p-8">
              <span className="badge bg-gold-100 text-gold-700 mb-3 inline-block">
                {featured.category}
              </span>
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {[
            ...
            <button
              key={cat}
              className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${i === 0 ? "bg-navy-800 text-white" : "bg-white border border-gray-200 text-gray-600 hover:border-navy-300"}`}
            >
              {cat}
            </button>
          ))}
